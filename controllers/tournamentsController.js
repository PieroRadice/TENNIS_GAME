...
const getTournamentUsers = async (req, res) => {
  try {
    res.status(200).json(await serviceTournament.getTournamentUsers(req.params.ID));
  } catch (error) {
...
const getTournamentUser = async (req, res) => {
  try {
    res.status(200).json(await serviceTournament.getTournamentUser(req.params.ID, req.params.user_id));
  } catch (error) {
...
const getTournamentPlayers = async (req, res) => {
  try {
    res.status(200).json(await serviceTournament.getTournamentPlayers(req.params.ID));
  } catch (error) {
