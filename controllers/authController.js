//richiamo l'oggetto connessione e ciò che mi serve dal packege sequelize
//const connessione = require("../config/connessione");
//const Users = require("../models/z_Users");
...
const confermaSignup = async (req, res) => {
  ...
  try {
    const user = await Users.findOne({ where: { uuid: tokenConfermaSignup } });
